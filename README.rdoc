...
First let's look at the iteration methods (the args method is shown too).
    ...
    germany.effective_periods_formatted                     # [{:start => '0000-01-01', :end => '1949-10-07'},{:start => '1949-10-07', :end => '1990-10-03'},{:start => '1990-10-03', :end => '9999-12-31'}]
    Country.effective_periods_formatted('%Y-%m-%d',identity: 'DEU')

    germany.effective_periods_formatted('%d.%m.%Y')         # [{:start => '01.01.0000', :end => '07.10.1949'},{:start => '07.10.1949', :end => '03.10.1990'},{:start => '03.10.1990', :end => '31.12.9999'}]
...
The iteration methods are also available to period instances.
    ...
    periods[0].formatted                                # {:start => '0000-01-01', :end => '1949-10-07'}
    periods[0].formatted('%d.%m.%Y')                    # {:start => '01.01.0000', :end => '07.10.1949'}
