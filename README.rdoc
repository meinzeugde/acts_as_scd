...
If you plan on forking and developing the gem, you can run tests with 'rake test'.
...
In case you didn't create a test database for the mysql2 adapter, run the following
