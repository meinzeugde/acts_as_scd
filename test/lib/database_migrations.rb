# Tribute goes to: http://exposinggotchas.blogspot.de/2011/02/activerecord-migrations-without-rails.html
...
namespace :db do
  ...
  task :configuration => :environment do
    @config = YAML.load_file(File.join(Dir.pwd, "test", "dummy", "config", "database.yml"))[DATABASE_ENV]
  end
